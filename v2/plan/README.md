# emage.code v2 — Plan documents

This folder hosts the v2 design documents. v1's documents under `../` remain as historical reference; v2 supersedes them.

## Index
- [00-vision-v2.md](00-vision-v2.md) — Why v2 exists; what changed.
- [01-shared-knowledge-architecture.md](01-shared-knowledge-architecture.md) — Single source of truth + projection model.
- [02-platform-adapter-spec.md](02-platform-adapter-spec.md) — Manifest schema + frontmatter transforms.
