...
- **[`docs/deployment/README.md`](README.md)** — the deployment index. Start here if you haven't chosen
...
- **[`docs/deployment/local-docker-desktop-guide.md`](local-docker-desktop-guide.md)** — the guide to
...
- **`docs/deployment/cwso-emage-orchestrator-connection-guide.md`** — a companion guide (present in this
