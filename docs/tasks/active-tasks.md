...
| T223 | Run SIA generation via harness launcher; confirm Parquet capture | qa-engineer | in_review | P0 | T220, T221, T222 | 2026-06-22 |
| T224 | Attach reward via `rollout_session_id` through merge | backend-developer | pending | P0 | T223, T212 | 2026-06-22 |
