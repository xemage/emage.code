...
| T224 | Attach reward via `rollout_session_id` through merge | backend-developer | in_progress | P0 | T223, T212 | 2026-06-23 |
| T225 | Reward shaping: merge ±1 + `results.json` eval metric | backend-developer | pending | P1 | T224 ✅ | 2026-06-23 |
