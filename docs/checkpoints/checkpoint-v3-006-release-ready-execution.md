...
- T039: v3 canonical tree bootstrapped (`implementation/knowledge`, `platforms`, `_extras`, `docs`, conventions files)
...
- T043: v3 docs and runbooks updated (`implementation/README.md`, `README.md`, `CONTRIBUTING.md`, `docs/wiki/v3-implementation.md`)
...
## Key decisions
- v3 now uses a native default drift root (`implementation`) while preserving optional v2 compatibility checks via `--root`.
