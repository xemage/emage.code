...
<!-- Fixture-authoring note: markdown links in the original file have been converted to plain
     inline code spans below, since their relative targets only resolve from the original
     docs/artifacts/ location and would otherwise false-trigger this repo's
     tests/functional/test_link_integrity.py when copied under tests/golden/. No other content
     changed. -->

Status: Experimental
Based on: `implementation/triggers/spec-v1.md`
...
- `implementation/adapters/antigravity_adapter.py`
- `implementation/adapters/opencode_adapter.py`
- `implementation/adapters/smoke.py`
